...
const Boards = ({
  ...
  sfModel.scene.scale.x = 0.06;
  sfModel.scene.scale.y = 0.06;
  sfModel.scene.scale.z = 0.06;
  sfModel.scene.rotation.y = Math.PI / 2;

  // chatModel.scene.position.y = 5;
  // chatModel.scene.position.x = -6;
  // chatModel.scene.position.z = -7;
  // chatModel.scene.scale.x = 0.05;
  // chatModel.scene.scale.y = 0.05;
  // chatModel.scene.scale.z = 0.005;
  // chatModel.scene.rotation.y = 1.5;
  // chatModel.scene.rotation.x =  1.5;
  // chatModel.scene.rotation.Z = 1.5;
  chatModel.scene.position.y = 0.1;
  chatModel.scene.position.x = -2;
  chatModel.scene.position.z = -2;
  chatModel.scene.scale.x = 0.05;
  chatModel.scene.scale.y = 0.05;
  chatModel.scene.scale.z = 0.05;
  chatModel.scene.rotation.y = Math.PI / 2;


  mfModel.scene.position.y = -100;
  ...
  iicModel.scene.scale.x = 0.03;
  iicModel.scene.scale.y = 0.03;
  iicModel.scene.scale.z = 0.03;
  iicModel.scene.rotation.y = Math.PI / 2;

  eventsModel.scene.position.y = -100;
  ...
  loginModel.scene.position.y = -100;
  ...
  mcModel.scene.position.x = -10;
  // mcModel.scene.position.z = 0;
  mcModel.scene.scale.x = 0.09;
  mcModel.scene.scale.y = 0.09;
  mcModel.scene.scale.z = 0.09;
  // mcModel.scene.rotation.y = Math.PI / 2;

  mcLeft.scene.position.y = -100;
  ...
  return (
    <>
      ...
      />
      <Board x={-120} z={-70} text="G-chatting" font={font} model={chatModel} />
      <Board
        x={-60}
        z={-140}
        text="Quick Connect"
